				...
				<div class="am-container header">
					...
					<ul class="message-r">
						<div class="topMessage home">
							<div class="menu-hd">
								<a href="goodslist.action" target="_top" class="h">商城首页</a>
							</div>
						</div>
	...
	<div class="center">
		<div class="col-main">
								...
								<div class="s-item-wrap">
									<div class="s-item">
										...
										<div class="s-pic">
											...
											<a href="goodsinfo.action?id=${mylistvo.kid }" class="s-pic-link"> <img
												src="${mylistvo.imgSrc }"
										...
										<div class="s-info">
											<div class="s-title">
												<a href="#" title="4折抢购!十二生肖925银女戒指,时尚开口女戒">${mylistvo.name }</a>
											</div>
											<div class="s-price-box">
												<span class="s-price"><em class="s-price-sign">¥</em><em
													class="s-value">${mylistvo.price }</em></span> 
											</div>
											<div class="s-extra-box">
												<span class="s-comment">评论条数：${mylistvo.commentNum }</span> &nbsp;&nbsp; <a
													href="attention.action?type=3&&aid=${mylistvo.id }"><span
													class="s-sales">取消关注</span></a>
											</div>
										</div>
										<!-- <div class="s-tp">
			...
			<div class="footer">
				<div class="footer-hd">
					<p>
						<a href="#">恒望科技</a> <b>|</b> <a href="goodslist.action">商城首页</a> <b>|</b> <a
