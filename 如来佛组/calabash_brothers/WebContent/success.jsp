...
<body>
	...
	<div class="nav-table">
		...
		<div class="nav-cont">
			<ul>
				<li class="index"><a href="goodslist.action">首页</a></li>
		...
		<div class="col-main">
			<div class="main-wrap">
				...
				<div class="user-order">
						...
						<p style="font-size: 34px; text-align: center;">余额不足</p>
						<a href="http://172.3.21.202:8080/creditloan/"><img alt="是否需要贷款" src="image/timg.jpg" style="width: 1200px;height: 900px;margin: 0 auto;">
					</a>
				</div>
			</div>
			<!--底部-->
